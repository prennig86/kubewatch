...
| `webex.notificationlist`                 | Webex List of objects to notify by namespaces and kind                           | `""`                   |
| `webex.notificationlist.namespace`       | Webex namespace to notify                                                        | `""`                   |
| `webex.notificationlist.kind`            | Webex kind to notify                                                             | `""`                   |
